...
class MessageModel(db.Model):
    ...
    FLAIRS = db.Column(db.String(120), unique=False, nullable=False, primary_key=False)
    ...
    def __repr__(self):
        return 'MESSAGE {} {} {} {} {} {} {}'.format(self.message_id, self.FLAIRS, self.date_sent, self.num_upvotes, self.payload, self.from_session_id, self.from_user) 
    ...
    def MessageToJSON(self):
        from_user = "Anonymous" if self.IS_ANON else self.from_user
        return {
        PacketAttributes.MESSAGE_ID.name : self.message_id,
        PacketAttributes.FLAIRS.name : self.FLAIRS.split(";"),
        ...
        PacketAttributes.FROM_USER.name : from_user,
